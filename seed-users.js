...
module.exports = [
  ...
  { firstName:'Test',       lastName:'T. Employer',   email:'employer@emphora.dev',               password:'test-1234', accountType:'employer',   emphoraScore:85.0, isVerified:1, isActive:1 },
  ...
  { firstName:'Melify',      lastName:'T. LLC',          email:'hr@melify.emphora.dev',              password:'test-1234', accountType:'employer', emphoraScore:92.0, isVerified:1, isActive:1 },
  { firstName:'Fiserv',      lastName:'T. Recruiting',   email:'hr@fiserv.emphora.dev',              password:'test-1234', accountType:'employer', emphoraScore:88.0, isVerified:1, isActive:1 },
  { firstName:'Orion',       lastName:'T. Inc.',         email:'hr@orion.emphora.dev',               password:'test-1234', accountType:'employer', emphoraScore:85.0, isVerified:1, isActive:1 },
  { firstName:'JPMorgan',    lastName:'T. Chase',        email:'hr@jpmorgan.emphora.dev',            password:'test-1234', accountType:'employer', emphoraScore:91.0, isVerified:1, isActive:1 },
  { firstName:'DTCC',        lastName:'T. Recruiting',   email:'hr@dtcc.emphora.dev',               password:'test-1234', accountType:'employer', emphoraScore:84.0, isVerified:1, isActive:1 },
  { firstName:'Barclays',    lastName:'T. Bank',         email:'hr@barclays.emphora.dev',            password:'test-1234', accountType:'employer', emphoraScore:87.0, isVerified:1, isActive:1 },
  { firstName:'Fannie',      lastName:'T. Mae',          email:'hr@fanniemae.emphora.dev',           password:'test-1234', accountType:'employer', emphoraScore:83.0, isVerified:1, isActive:1 },
  { firstName:'Fidelity',    lastName:'T. Investments',  email:'hr@fidelity.emphora.dev',            password:'test-1234', accountType:'employer', emphoraScore:90.0, isVerified:1, isActive:1 },
  { firstName:'Acme',        lastName:'T. Corp',         email:'hr@acmecorp.emphora.dev',            password:'test-1234', accountType:'employer', emphoraScore:74.0, isVerified:1, isActive:1 },
  { firstName:'TechNova',    lastName:'T. Inc.',         email:'hr@technova.emphora.dev',            password:'test-1234', accountType:'employer', emphoraScore:82.0, isVerified:1, isActive:1 },
  { firstName:'Brightline',  lastName:'T. Systems',      email:'hr@brightline.emphora.dev',          password:'test-1234', accountType:'employer', emphoraScore:79.0, isVerified:1, isActive:1 },
  { firstName:'Apex',        lastName:'T. Digital',      email:'hr@apexdigital.emphora.dev',         password:'test-1234', accountType:'employer', emphoraScore:77.0, isVerified:1, isActive:1 },
  { firstName:'Quantum',     lastName:'T. Works',        email:'hr@quantumworks.emphora.dev',        password:'test-1234', accountType:'employer', emphoraScore:81.0, isVerified:1, isActive:1 },
  { firstName:'Meridian',    lastName:'T. Labs',         email:'hr@meridianlabs.emphora.dev',        password:'test-1234', accountType:'employer', emphoraScore:78.0, isVerified:1, isActive:1 },
  { firstName:'Solstice',    lastName:'T. AI',           email:'hr@solsticeai.emphora.dev',          password:'test-1234', accountType:'employer', emphoraScore:86.0, isVerified:1, isActive:1 },
  { firstName:'Ironclad',    lastName:'T. Tech',         email:'hr@ironcladtech.emphora.dev',        password:'test-1234', accountType:'employer', emphoraScore:76.0, isVerified:1, isActive:1 },
  { firstName:'Vantage',     lastName:'T. Solutions',    email:'hr@vantagesolutions.emphora.dev',    password:'test-1234', accountType:'employer', emphoraScore:80.0, isVerified:1, isActive:1 },
  { firstName:'Nexus',       lastName:'T. Corp',         email:'hr@nexuscorp.emphora.dev',           password:'test-1234', accountType:'employer', emphoraScore:75.0, isVerified:1, isActive:1 },
  { firstName:'Pinnacle',    lastName:'T. Software',     email:'hr@pinnaclesoftware.emphora.dev',    password:'test-1234', accountType:'employer', emphoraScore:83.0, isVerified:1, isActive:1 },
  { firstName:'Atlas',       lastName:'T. Engineering',  email:'hr@atlasengineering.emphora.dev',    password:'test-1234', accountType:'employer', emphoraScore:78.0, isVerified:1, isActive:1 },
  { firstName:'Horizon',     lastName:'T. Dynamics',     email:'hr@horizondynamics.emphora.dev',     password:'test-1234', accountType:'employer', emphoraScore:77.0, isVerified:1, isActive:1 },
  { firstName:'Vertex',      lastName:'T. Technologies', email:'hr@vertextech.emphora.dev',          password:'test-1234', accountType:'employer', emphoraScore:82.0, isVerified:1, isActive:1 },
  { firstName:'Crestwood',   lastName:'T. Digital',      email:'hr@crestwooddigital.emphora.dev',    password:'test-1234', accountType:'employer', emphoraScore:74.0, isVerified:1, isActive:1 },
  { firstName:'Lighthouse',  lastName:'T. Analytics',    email:'hr@lighthouseanalytics.emphora.dev', password:'test-1234', accountType:'employer', emphoraScore:80.0, isVerified:1, isActive:1 },
  { firstName:'Cascade',     lastName:'T. Software',     email:'hr@cascadesoftware.emphora.dev',     password:'test-1234', accountType:'employer', emphoraScore:76.0, isVerified:1, isActive:1 },
  { firstName:'Summit',      lastName:'T. Tech',         email:'hr@summittech.emphora.dev',          password:'test-1234', accountType:'employer', emphoraScore:79.0, isVerified:1, isActive:1 },
  { firstName:'Ember',       lastName:'T. Labs',         email:'hr@emberlabs.emphora.dev',           password:'test-1234', accountType:'employer', emphoraScore:72.0, isVerified:1, isActive:1 },
